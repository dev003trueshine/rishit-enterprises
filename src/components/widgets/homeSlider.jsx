...
const slides = [
  ...
  },
  {
    ...
    desc: "Our signature mango pulps capture the essence of fresh fruits, perfect for smoothies, desserts, and traditional recipes.",
  },
];
              ...
              <div className="banner-overlay">
                ...
                <div className="banner-content">
                  ...
                  <div className="d-flex flex-column flex-sm-row gap-3">
                    <button onClick={handleWhatsAppClick} className="d-flex align-items-center justify-content-center gap-12 px-8 py-4 btn btn-success text-white rounded-lg fw-bold text-lg shadow-lg">
                      Order on WhatsApp
                    </button>
